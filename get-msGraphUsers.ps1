function Get-MSGraphUsers
{
    ...
    $propertiesToObtain="UserPricipalName,ProxyAddresses"
    ...
    try {
        ...
        $userList = [System.Collections.Generic.List[Object]]@(get-MGUser -all -Property $propertiesToObtain -errorAction Stop)
