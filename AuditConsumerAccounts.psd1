...
NestedModules = @('Out-XMLFile.ps1','Get-MSGraphusers.ps1','Verify-GraphConnection.ps1','New-GraphConnection.ps1','Write-FunctionParameters.ps1','Test-PowerShellModule.ps1','Disable-AllPowershellSessions.ps1','Get-UniversalDateTime.ps1','New-LogFile.ps1','Out-LogFile.ps1','Start-TelemetryConfiguration.ps1')
