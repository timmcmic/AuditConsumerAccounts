...
NestedModules = @('create-psjobs.ps1','test-jobStatus.ps1','validate-jobStatus.ps1','Start-SleepProgress.ps1','get-MultipleXMLFiles.ps1','Clear-PSJob.ps1','Get-ChunkList.ps1','Start-MultipleAuditConsumerAccounts.ps1','send-TelemetryEvent.ps1','Get-ElapsedTime.ps1','Generate-HTMLFile.ps1','Get-ConsumerAccounts.ps1','Out-CSVFile.ps1','Get-AddressesToTest.ps1','Get-MSGraphDomains.ps1','Out-XMLFile.ps1','Get-MSGraphusers.ps1','Verify-GraphConnection.ps1','New-GraphConnection.ps1','Write-FunctionParameters.ps1','Test-PowerShellModule.ps1','Disable-AllPowershellSessions.ps1','Get-UniversalDateTime.ps1','New-LogFile.ps1','Out-LogFile.ps1','Start-TelemetryConfiguration.ps1')
